...
while IFS= read -r line || [ -n "$line" ]; do
    case "$line" in
        ...
        GEOGUESSME_KEYCLOAK_SMTP_USER=*) printf 'GEOGUESSME_KEYCLOAK_SMTP_USER=%s\n' "$KEYCLOAK_SMTP_USERNAME" ;;
        GEOGUESSME_KEYCLOAK_SMTP_PASSWORD=*) printf 'GEOGUESSME_KEYCLOAK_SMTP_PASSWORD=%s\n' "$KEYCLOAK_SMTP_PASSWORD" ;;
        ...
        GEOGUESSME_GITHUB_CLIENT_ID=*) printf 'GEOGUESSME_GITHUB_CLIENT_ID=local-github-placeholder\n' ;;
        GEOGUESSME_GITHUB_CLIENT_SECRET=*) printf 'GEOGUESSME_GITHUB_CLIENT_SECRET=local-github-placeholder\n' ;;
        GEOGUESSME_APPLE_CLIENT_ID=*) printf 'GEOGUESSME_APPLE_CLIENT_ID=local-apple-placeholder\n' ;;
        GEOGUESSME_APPLE_CLIENT_SECRET=*) printf 'GEOGUESSME_APPLE_CLIENT_SECRET=local-apple-placeholder\n' ;;
        *) printf '%s\n' "$line" ;;
    esac
