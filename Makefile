...
.PHONY: help impact bootstrap bootstrap-preflight bootstrap-integration bootstrap-e2e hooks-install hooks-check tools-self-test tools-clean \
	...
	test-ci-classifier test-e2e-regression test-dev-workflow-regression test-restart-regression test-qa-agent qa-agent qa-agent-fast qa-agent-full qa-agent-nightly qa-browser-mcp \
