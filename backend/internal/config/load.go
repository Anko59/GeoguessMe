...
func Load() (*Config, error) {
	...
	cfg := &Config{
		...
		RateLimitPolicies: []RateLimitPolicy{
			...
			{Name: "default", Buckets: l.rateLimitPolicies("RATE_LIMIT_DEFAULT", "route:120/1m,trustedIP:1200/1m")},
			{Name: "write", Buckets: l.rateLimitPolicies("RATE_LIMIT_WRITE", "route:60/1m,trustedIP:600/1m")},
		},
