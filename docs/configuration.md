...
| `RATE_LIMIT_DEFAULT`              | buckets  | `route:120/1m,trustedIP:1200/1m`               | All        | Read policy: route buckets are scoped by authenticated user and method/pattern; trusted-IP remains the aggregate abuse guard.                                                                                                                                                                     |
| `RATE_LIMIT_WRITE`                | buckets  | `route:60/1m,trustedIP:600/1m`                 | All        | Write policy: route buckets are scoped by authenticated user and method/pattern; trusted-IP remains the aggregate abuse guard.                                                                                                                                                                    |
