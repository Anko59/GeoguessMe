...
| `RATE_LIMIT_EMAIL`       | buckets  | `identity:3/1h,trustedIP:5/1h,global:30/1m`    | All        | Verification/recovery email policy                                                                                                                              |
...
| `RATE_LIMIT_DEFAULT`     | buckets  | `identity:10/1m,trustedIP:60/1m`               | All        | Default auth-route policy                                                                                                                                       |
...
| `RATE_LIMIT_STORE_CAP`   | int      | `50000`                                        | All        | Must be ≥ 1; process-wide maximum number of live rate-limit counters                                                                                            |
